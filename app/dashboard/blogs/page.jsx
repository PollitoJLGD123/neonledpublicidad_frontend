...
export default function Page() {
    return (
        <div className="flex w-full justify-center items-center">
            <div className="bg-gradient-to-r from-[#4450f8]-500 to-[#1056d2]-600 rounded-2xl shadow-xl w-full max-w-6xl overflow-hidden">
                <InfoSelectorTemplate />
